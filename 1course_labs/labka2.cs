...
namespace labka_2
{
    class OiynTop
    {
        ...
        public static void Jarys(List<OiynTop> t, int rand1, int rand2)
        {
            Thread thread = null;
            thread = new Thread(() =>
            {

                Console.Write($"{t[rand1].top_number} <=======> {t[rand2].top_number}  oiyndy bastady!\n\n");
                ...
                if (t[rand1].top_number > t[rand2].top_number)
                {
                    ...
                    Console.WriteLine($"1-Qarsylas id - {t[rand1].top_number} <=======> 2-Qarsylas id - {t[rand2].top_number}");
                }
                else
                {
                    int oiynshy = rnd.Next(5, 7);
