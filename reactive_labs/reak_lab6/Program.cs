    ...
    internal class Program
    {
        ...
        private static void GeneratingWithObservable(List<Tovar> tv, Tovar t)
        {
            ...
            var subscription = generator
                ...
                .Timestamp()
                .DelaySubscription(TimeSpan.FromSeconds(5))  //бул жерде синхронды методка подписка жасаиды, подписка 5 сек сайын жасаылып отырады
        ...
        private static void GeneratingAsynchronously(List<Tovar> tv, Tovar t)
        {
            ...
            var subscription =
                primesObservable.Timestamp()
                .DelaySubscription(TimeSpan.FromSeconds(5)) //TimeSpan  DelaySubscription конвейерге косылган уакыттан емес, ол тек подписка суралған уакыттан бастап жасаиды
