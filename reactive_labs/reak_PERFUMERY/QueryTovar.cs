...
{//консольге наблюдаемый обьекттын арекетын жазады.
    internal class QueryTovar : IObserver<Tovar>  //QueryTovar деген наблюдател курдым, максаты бызге товардын кандаи не каи запроспен аякталатынын бакылау 
    {
        ...
        {
            Console.WriteLine("{1}: The name tovara is {0} ", value.tovar_name, this.NameQuery + "\n"); //обьектты каи наблюдател алганын корсету
            value.Info();   //обьекты туралы информация шыгару
        }
